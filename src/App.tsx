...
import {
  Menu, X, FileText, Dna, Brain, FlaskConical, Users, Star, BarChart2,
...
// ── Icon map (so we can reference icons by string name from JSON) ──────────────
...
// Custom LinkedIn SVG (removed from lucide-react in newer versions)
...
function Navbar() {
  ...
  const navLinks: string[] = data.navigation
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <a href="#home" className="flex items-center gap-2.5 group">
            ...
            <span className="font-bold text-gray-900 text-sm tracking-tight">{data.profile.name}</span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-1">
            {navLinks.map((link) => (
              <a
                ...
                className="px-3 py-2 text-sm font-medium text-gray-600 rounded-lg hover:text-blue-600 hover:bg-blue-50 transition-all duration-200"
              >
                {link}
              </a>
            ))}
          ...
          <div className="hidden md:flex items-center gap-3">
            <a
              ...
              className="flex items-center gap-1.5 px-4 py-2 rounded-lg border border-blue-600 text-blue-600 text-sm font-semibold hover:bg-blue-600 hover:text-white transition-all duration-200"
            >
...
function HeroSection() {
  const { profile } = data
  return (
    <section id="home" className="pt-24 pb-16 lg:pt-32 lg:pb-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center md:justify-end">
            <div className="relative">
              ...
              />
              {/* Floating badge */}
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg px-4 py-2.5 border border-gray-100">
                <div className="flex items-center gap-2">
                  <div className="w-2.5 h-2.5 rounded-full bg-green-400 animate-pulse" />
                  <span className="text-xs font-semibold text-gray-700">{profile.status}</span>
                </div>
              </div>
            </div>
          </div>
    ...
    <section id="research" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          ...
          subtitle="My research sits at the intersection of biology, statistics, and deep learning — three disciplines that together unlock the complexity of living systems."
        />
        ...
        <div className="mt-10 relative rounded-2xl overflow-hidden h-52 shadow-lg">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-gray-900/80 to-gray-900/40 flex items-center px-10">
            <div>
              ...
              <a
                href={labBanner.ctaHref}
                className="mt-3 inline-flex items-center gap-2 text-blue-300 text-sm font-semibold hover:text-white transition-colors"
              >
    ...
    <section id="teaching" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          ...
          subtitle="Bridging theory and practice — my courses equip students with computational skills grounded in real biological questions."
        />
    ...
    <footer id="contact" className="bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            <Badge>Contact</Badge>
            <h2 className="mt-4 text-3xl sm:text-4xl font-bold text-gray-900 tracking-tight">Let's Collaborate</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    placeholder="Tell me about your research interests or questions..."
                    value={form.message}
      ...
      <div className="border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-sm text-gray-400">
